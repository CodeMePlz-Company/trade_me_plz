...
* **Technical Indicators:** Computes RSI, Moving Averages (MA), and Bollinger Bands.
...
* **Logger:** Maintaining a complete audit trail of every decision and system state.
...
* **Notifications:** Sends instant updates and trade summaries via **LINE Notify**.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/CodeMePlz-Company/trade_me_plz.git](https://github.com/CodeMePlz-Company/trade_me_plz.git)
